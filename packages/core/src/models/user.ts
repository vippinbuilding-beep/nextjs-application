...
// Kept in sync with `CreatorProfileTab` in the web app's
// `lib/creator-profile-tabs.ts`, which owns the labels/UI logic for tabs.
export type CreatorProfileTab = "links" | "lessons" | "documents";
